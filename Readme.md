...
This is the basis of all jesperancinha and JEsperancinhaORG handlers for GitHub. In this project, you'll find monitoring files, status files, migration files, update scripts, and an autogenerated reporting project. There are other things like docker image experiments, cypress tests, and templates.
