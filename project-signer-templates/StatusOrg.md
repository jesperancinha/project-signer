# jesperancinha.org organization project statuses

Here are the status of  all the libraries that I have developed for use in the public domain
...
Contains the ITF Library for Java
...
Contains the ITF library for android
