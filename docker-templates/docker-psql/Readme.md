# Multiple database setup example

This example is taken from my project [![Generic badge](https://img.shields.io/static/v1.svg?label=GitHub&message=StaCo%20App%20🪙%20&color=informational)](https://github.com/jesperancinha/staco-app).

It provides support to a multidatabase system inspired by Spring Auto-scanning and using Postgres official Docker Hub images.
